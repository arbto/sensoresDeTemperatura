...
namespace graficoDeTemperatura_2
{
    public partial class Form2 : Form
    {
        ...
        public void plotarTresGraficos(String nomeDoGrafico1, String nomeDoGrafico2, String nomeDoGrafico3, int larguraDoGrafico, int numeroDePontos,
            decimal[] dadosY1, DateTime[] dadosX1, decimal[] dadosY2, DateTime[] dadosX2, decimal[] dadosY3, DateTime[] dadosX3)
        {
            chart1.Series.Clear();
            chart1.Titles.Clear();
            chart1.Legends.Clear();
            ...
            this.chart1.Titles.Add(nomeDoGrafico1 + ", " + nomeDoGrafico2 + " e " + nomeDoGrafico3);
